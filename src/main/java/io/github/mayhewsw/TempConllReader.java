 ...
 *
 * DELETE THIS CLASS WHEN THE UPDATED CONLLNERREADER IS PUBLISHED TO MAVEN!!!!
 *
 * THIS SHOULD HAPPEN AROUND MAY 20, PROBABLY.
 *
 * Created by mayhew2 on 7/20/16.
 */
@Deprecated
public class TempConllReader extends AnnotationReader<TextAnnotation> {

    private static Logger logger = LoggerFactory.getLogger(TempConllReader.class);
     ...
     */
    public TempConllReader(String conlldirectory) {
